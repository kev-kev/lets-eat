...
Recipe.create(name: 'Another Pork Bo Ssam', link: 'https://cooking.nytimes.com/recipes/12197-momofukus-bo-ssam', notes: 'Overnight marinade, 6 hour roast at 300', user_id: 1, status: 0, is_favorited: true)
Recipe.create(name: 'It\'s Kimchi Soondubu Jjigae (Soft Tofu Stew)', link: 'https://www.koreanbapsang.com/kimchi-soondubu-jjigae-soft-tofu-stew-kimchi/', user_id: 2, status: 0, is_favorited: true)
