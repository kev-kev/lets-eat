...
# approved recipes
Recipe.create!(name: 'Turkey Tetrazzini', link: 'https://www.simplyrecipes.com/recipes/turkey_tetrazzini/', notes: 'Sub oatmilk for the heavy cream and add 1 tbsp extra butter', user_id: 1, status:1, upcoming: true)
