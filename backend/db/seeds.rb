...
if ENV["IS_DEMO"]
  puts "Demo Environment Seed Running"
  User.create(username: "Kirby", password: "time2eat", password_confirmation: "time2eat")
  User.create(username: "WaddleDee", password: "time2eat", password_confirmation: "time2eat")
  60.times do 
